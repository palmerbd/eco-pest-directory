...
const CITY_INTRO_COPY: Record<string, string> = {
  ...
  "chicago": `Chicago's dance studio scene reflects the city's deep artistic roots — from Magnificent Mile ballrooms to neighborhood gems in Lincoln Park and the South Loop. The city's diverse cultural fabric shows in the range of styles offered, with everything from competitive ballroom to Afro-Cuban rhythms, all taught by passionate instructors who understand the Midwest's welcoming spirit.`,
  ...
  "nashville": `Nashville's rise as a national destination city has brought a dance studio boom. Beyond country line dancing, Music City has cultivated serious ballroom and Latin instruction, with studios drawing from the city's deep pool of musically sophisticated residents who bring rhythm and precision to everything they do.`,
...
const CITY_INTRO_FALLBACK = (cityName: string) =>
  `Discover private ballroom and Latin dance studios in ${cityName}. Our curated selection of instructors offers personalized lessons across all major styles — whether you're a beginner looking to gain confidence, preparing for a special event, or training for competitive advancement. Find your perfect match and start dancing today.`;
...
const STYLE_INTRO_COPY: Record<StyleKey, Record<string, string>> = {
  ...
  latin: {
    ...
    "chicago": `Chicago's Latin dance studios celebrate the city's diverse Latin American community. Rumba, Samba, Cha-Cha, and Mambo are taught with authenticity and enthusiasm, creating a welcoming environment for dancers at every level.`,
  ...
  wedding_dance: {
    ...
    "los-angeles": `Wedding dance studios in LA offer professional choreography and instruction for your first dance. Whether you choose waltz, contemporary, or a personalized style, LA instructors create beautiful, memorable moments for your wedding.`,
    "chicago": `Chicago's wedding dance studios specialize in creating magical first dances. Instructors work with couples to develop personalized choreography that reflects their style and musical taste.`,
    ...
    "miami": `Wedding dance studios in Miami offer vibrant choreography options, from traditional waltz to Latin-infused styles. Local instructors help couples create memorable moments that reflect their personality and cultural background.`,
    "atlanta": `Atlanta's wedding dance studios create beautiful, personalized first dances for couples. Instructors work closely with couples to develop choreography that matches their style, music, and vision.`,
    ...
    "denver": `Wedding dance studios in Denver offer personalized choreography for couples. Instructors help create memorable first dances that capture the joy and romance of your special day.`,
    ...
    "san-diego": `Wedding dance studios in San Diego offer joyful, romantic choreography for couples. Instructors create personalized first dances that capture the beauty and excitement of your wedding day.`,
  },
  competition: {
    ...
    "los-angeles": `LA's competition dance studios attract serious competitors from across the region. Studios offer medal programs, showcase opportunities, and coaching from champions who understand what it takes to win on the competitive floor.`,
    ...
    "denver": `Denver's competition dance studios offer serious training for aspiring champions. Studios provide medal programs, coaching from experienced competitors, and showcase opportunities for advancing dancers.`,
